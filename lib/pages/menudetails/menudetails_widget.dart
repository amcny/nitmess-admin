...
import 'menudetails_model.dart';
export 'menudetails_model.dart';
...
class _MenudetailsWidgetState extends State<MenudetailsWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MenudetailsModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<MessRecord>(
      stream: MessRecord.getDocument(widget.messDocRef!),
      builder: (context, snapshot) {
        ...
        final menudetailsMessRecord = snapshot.data!;
                            ...
                            children: [
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  await widget.messDocRef!
                                      .update(createMessRecordData(
                                    lunch: _model.textController2.text,
                                  ));
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: const Text(
                            ...
                            children: [
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  await widget.messDocRef!
                                      .update(createMessRecordData(
                                    snacks: _model.textController3.text,
                                  ));
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: const Text(
                            ...
                            children: [
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  await widget.messDocRef!
                                      .update(createMessRecordData(
                                    dinner: _model.textController4.text,
                                  ));
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: const Text(
