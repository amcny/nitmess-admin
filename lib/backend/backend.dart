...
import 'schema/scanned_outputs_record.dart';
...
export 'schema/scanned_outputs_record.dart';
...
/// Functions to query ScannedOutputsRecords (as a Stream and as a Future).
Future<int> queryScannedOutputsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      ScannedOutputsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<ScannedOutputsRecord>> queryScannedOutputsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      ScannedOutputsRecord.collection,
      ScannedOutputsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<ScannedOutputsRecord>> queryScannedOutputsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<int> queryMessRecordCount({
  ...
  int limit = -1,
    ...
    queryCollectionCount(
      MessRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<MessRecord>> queryMessRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      MessRecord.collection,
      MessRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<MessRecord>> queryMessRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
